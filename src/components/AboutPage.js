...
const AboutPage = () => {
	...
	<div>
		...
		<h3>See the code:</h3>
		<ul>
			<li><a href="https://bitbucket.org/claire-ryberg/react-expat" target="_blank" rel="noopener noreferrer">Bitbucket</a></li>
		...
		<ul>
			...
			<li>Allow the user to redirect to a paeg with the hourly forecast by clicking on a saved location</li>
			<li>Fix the content showing before the CSS is loaded</li>
			<li>Implement dropdown suggestion while typing a location name</li>
		</ul>
		...
		<ul>
			...
			<li>Rethink the structure for the store, especially in relation to localStorage</li>
		</ul>
	</div>
	);
};
